...
function cadastrar(req, res) {
    ...
    var empresaLocadora = req.body.locadoraServer;
    var empresaAlocacao = req.body.alocacaoServer;
    

        // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
        usuarioModel.cadastrar(nome, email, senha,tipoUsuario,empresaLocadora,empresaAlocacao)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
